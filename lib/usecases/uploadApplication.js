...
export default async ({
  ...
  await db.none(
    ...
    [
      grantApplication.id,
      eligibilityCriteriaDetails.tradingInHackney,
      ...
      eligibilityCriteriaDetails.business_category,
      eligibilityCriteriaDetails.business_sub_category,
      eligibilityCriteriaDetails.business_custom_category,
    ]
  );

  await db.one(
    `INSERT INTO contact
      (grant_application_id, first_name, last_name, email_address, telephone_number)
      VALUES($1, $2, $3, $4, $5)
      RETURNING id
    `,
    [
