...
export default async ({
  ...
  await db.none(
    ...
    [
      ...
      options.RATEABLE_LIMIT_ANSWERS.indexOf('Not Applicable') + 1,
  ...
  await db.none(
    `INSERT INTO declaration
     (grant_application_id, state_aid_received, permitted_to_accept_state_aid_grant, read_understood_declaration, state_aid_option_id, date_of_aid, organisation_providing_aid)
     VALUES($1, $2, $3, $4, $5, $6, $7)`,
    [
      grantApplication.id,
      ...
      options.STATE_AID_OPTION.indexOf(declaration.stateAidOptionId) + 1,
      declaration.dateOfAid,
      declaration.organisationProvidingAid,
    ]
  );
