  ...
  return {
    application: {
      ...
      eligibilityCriteriaDetails: {
        ...
        tradingOn220320: booleanToYesNo(application.trading_on_22_03_20),
        tradingOn161020: booleanToYesNo(application.trading_on_16_10_20),
        tradingOn041120: booleanToYesNo(application.trading_on_04_11_20),
      ...
      declaration: {
        ...
        authoriseOnBehalf: booleanToYesNo(application.authorise_on_behalf),
        businessMeetsCriteria: booleanToYesNo(
          application.business_meets_criteria
        ),
        businessClosedByLaw: booleanToYesNo(application.business_closed_by_law),
        businessIntendsReopen: booleanToYesNo(
          application.business_intends_reopen
        ),
        businessIWillInform: booleanToYesNo(application.business_i_will_inform),
        businessNotExceed: booleanToYesNo(application.business_not_exceed),
        businessNotUndertaking: booleanToYesNo(
          application.business_not_undertaking
        ),
        businessNotRatePayer: booleanToYesNo(
          application.business_not_rate_payer
        ),
        businessPermitData: booleanToYesNo(application.business_permit_data),
        businessShareWithBEIS: booleanToYesNo(
          application.business_share_with_beis
        ),
        businessHappyContacted: booleanToYesNo(
          application.business_happy_contacted
        ),
      },
    },
