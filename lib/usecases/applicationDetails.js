...
export default async ({ clientGeneratedId }) => {
  ...
  return {
    application: {
      ...
      lrsgClosed5JanCycle2Amount: application.lrsg_closed_5_jan_cycle_2_amount,
      restartGrantAmount: application.restart_grant_amount,
      ...
      lrsgClosed5JanCycle2PaymentExported:
        application.lrsg_closed_5_jan_cycle_2_payment_exported,
      restartGrantPaymentExported: application.restart_grant_payment_exported,
      eligibilityCriteria: {
      ...
      eligibilityCriteriaDetails: {
        ...
        tradingOn040121: application.trading_on_04_01_21,
        tradingOn040121Cycle2: application.trading_on_04_01_21_cycle_2,
        tradingOn010421: application.trading_on_01_04_21,
...
const getApplicationData = async (dbInstance, clientGeneratedId) => {
  const query = `SELECT
                  ...
                  ecd.trading_on_04_01_21,
                  ecd.trading_on_04_01_21_cycle_2,
                  ecd.trading_on_01_04_21,
                  ...
                  aa.lrsg_closed_5_jan_cycle_2_amount,
                  aa.restart_grant_amount,
                  ...
                  aa.lrsg_closed_5_jan_cycle_2_payment_exported,
                  aa.restart_grant_payment_exported,
