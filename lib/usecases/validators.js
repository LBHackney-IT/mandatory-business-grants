...
const applicationSchema = yup.object().shape({
  ...
  eligibilityCriteriaDetails: yup
    ...
    .shape({
      ...
      tradingOn220320: yup.bool().transform(stringToBool).oneOf([undefined]),
      tradingOn161020: yup.bool().transform(stringToBool).oneOf([undefined]),
      tradingOn041120: yup.bool().transform(stringToBool).oneOf([undefined]),
      tradingOn301120: yup.bool().transform(stringToBool).oneOf([undefined]),
      tradingOn011220Open: yup
        .bool()
        .transform(stringToBool)
        .oneOf([undefined]),
      tradingOn011220: yup.bool().transform(stringToBool).oneOf([undefined]),
      tradingOn151220: yup.bool().transform(stringToBool).oneOf([undefined]),
      tradingOn191220: yup.bool().transform(stringToBool).oneOf([undefined]),
      tradingOn040121: yup.bool().transform(stringToBool).oneOf([undefined]),
      tradingOn040121Cycle2: yup.bool().transform(stringToBool).required(),
      tradingOn010421: yup.bool().transform(stringToBool).required(),
