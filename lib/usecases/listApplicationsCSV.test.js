  ...
  const databaseSpy = jest.fn(() => {
    ...
    for (let count = 1; count <= numberOfApplicationsInResponse; count++) {
      databaseResponse.push({
        ...
        lrsg_sector: `lrsg_sector${count}`,
        lrsg_open: `lrsg_open${count}`,
        lrsg_closed_businesses: `lrsg_closed_businesses${count}`,
        lrsg_open_v2: `lrsg_open_v2${count}`,
        lrsg_closed_tier_2: `lrsg_closed_tier_2${count}`,
        lrsg_closed_tier_3: `lrsg_closed_tier_3${count}`,
        lrsg_closed_tier_4: `lrsg_closed_tier_4${count}`,
        csp: `csp${count}`,
        lrsg_closed_5_jan_and_cblg: `lrsg_closed_5_jan_and_cblg${count}`,
